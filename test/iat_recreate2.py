...
def modify_pe(notp, dir, packer):
    dir_list = os.listdir(os.path.join(dir, packer))
    dir_list.sort()
...
homedir = '/home/cuckoo'
notp_dir = 'PackDataset/Notpacked'
dst_dir = 'advpacker'
notp = os.path.join(homedir, notp_dir)
