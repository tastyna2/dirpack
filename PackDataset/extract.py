...
class Sections(FeatureType):
    ...
    def __init__(self):
        ...
        self.sec_names = ['.rsrc', '.text', '.data', '.rdata', '.reloc', '\\xff\\xff\\xff\\xff\\xff\\xff\\xff\\xff',
            '.idata', '.tls', '', '.pdata', '.bss', 'UPX0', 'UPX1', '\\xf3\\xf3\\xf3\\xf3\\xf3\\xf3\\xf3\\xf3',
            '.edata', '\\xf6\\xf6\\xf6\\xf6\\xf6\\xf6\\xf6\\xf6', '.gfids', '.CRT', 'CODE', 'DATA',
            'BSS', '.bak', '/4', '.itext', '.imports', '.code', '.xdata', '.aspack', '.NewSec',
            'UPX2', '.00cfg', '.adata', '\\xe7\\xf7\\xff\\xe7\\xf7\\xff\\xe7\\xf7', '\\xf7\\xff\\xe7\\xf7\\xff\\xe7\\xf7\\xff',
            '\\xff\\xe7\\xf7\\xff\\xe7\\xf7\\xff\\xe7', '.didata', '\\xff', '\\xe9\\xe9\\xe9\\xe9\\xe9\\xe9\\xe9\\xe9',
            '.ndata', '_RDATA', '.qtmetad', 'f\\xff', '.MPRESS1', '.MPRESS2', '.', '/19', 'petite',
            '/57', '/31', '\\xce\\xce\\xce\\xce\\xce\\xce\\xce\\xce', 'kkrunchy', '/45', '/70',
            '\\xeb\\xec\\xe6\\xeb\\xec\\xe6\\xeb\\xec', '\\xe6\\xeb\\xec\\xe6\\xeb\\xec\\xe6\\xeb',
            '/81']
